...
oc9_MaterialSEPart1 = "Изделие-заготовка%RT"+<oc9_StockCompanyPart>
oc9_MaterialSEPart2 = ""

Если oc9_StockCommercialPart не пуст, тогда:
oc9_MaterialSEPart1 = "Изделие-заготовка%RT"+<oc9_ StockCommercialPart>
oc9_MaterialSEPart2 = ""
	...
	try {
		...
		if(strcmp("", prop)){
			...
			*rvalue = (char*) MEM_alloc(
							strlen("Изделие-заготовка%RT")
							+ strlen(prop) + 1);
			strcpy(*rvalue, "Изделие-заготовка%RT");
			strcat(*rvalue, prop);
			MEM_free(prop);
			return ITK_ok;
		}
